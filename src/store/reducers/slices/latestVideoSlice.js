    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await Promise.all([
                axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=ffb9cd11b4d0670af07fbe9d1b894317&language=en-US&sort_by=primary_release_date.desc&include_adult=false&include_video=false&page=1&vote_average.gte=6`)
                    .then(response => ({ title: "Latest Movies", videos: response.data.results })),
                axios.get(`https://api.themoviedb.org/3/discover/tv?api_key=ffb9cd11b4d0670af07fbe9d1b894317&language=en-US&sort_by=first_air_date.desc&page=1&timezone=America%2FNew_York&vote_average.gte=6&include_null_first_air_dates=false`)
